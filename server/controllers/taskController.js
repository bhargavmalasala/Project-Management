...
export const createTask = async (req, res) => {
    try {
        ...
        const { title, description, projectId, type, status, priority, assigneeId, due_date} = req.body;
        ...
        }else if(assigneeId && !project.workspace.members.some(member => member.user.id === assigneeId)){
